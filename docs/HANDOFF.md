...
**Recovered by** `build_archive.py` (in the project folder above the repo, not committed), from `import-friendsoftelfordtownpark/media/`; the originals are untouched there.
...
## Old-site photos — STAGED 2026-09-20 (not in the repo; gallery design undecided)
...
**Size:** adding all 223 would take the repository from about 17 MB to about 100 MB, on top of the archive PDFs (about 97 MB). Not decided: how the photos are shown (see the options discussed), what to caption, and whether to trim.
