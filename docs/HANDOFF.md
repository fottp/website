...
**Checked in the live CMS (2026-09-20):** editing the weekly event (adding a location and a photo) and taking it through Send for review, Ready and Publish. **Not yet checked:** the date pickers, and the skipped-dates list, in the live `/admin/`; the phone menu on the new pages; and the photo-shrinking setting above (added after that test). The old WordPress site's six events (2016–2018) were not imported.
